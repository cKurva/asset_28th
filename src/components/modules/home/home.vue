<template>
  <div class="home">
    <navbar />
    <div class="d-flex before_flex justify-content-between m-3">
    ...
    <div class="container-fluid mt-4">
      <div v-if="projectsArray.length > 0" class="row">
        <div v-for="(project, index) in sortedArray" :key="index" class="col-3">
          <b-card
            tag="article"
            class="shadow-sm"
          ...
          >
            ...
            >
              <b-button
                pill
                class="mx-1 transparentBg projectBtn"
                v-b-tooltip.hover
                title="Edit Project"
            ...
            <b-link class="card-btn text-primaryBg" href="#" @click="routeToMap(project)"
              >View</b-link
            >
            <b-link
              class="card-btn text-primaryBg ml-4"
              href="#"
            ...
            <b-link
              ...
              ><i class="fas fa-upload"></i></b-link>
          </b-card>
        </div>
      </div>
