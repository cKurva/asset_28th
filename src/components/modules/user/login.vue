...
<p><img src="@/assets/datasee_logo.png"/></p>
<p class="svg_img"><img src="@/assets/banner1.svg"/></p>
</div>
</div>
    <b-card tag="article" style="min-width:25rem;" class="mx-auto"
...
.inner_login{
    width: 70%;
    margin: 40px auto;
      box-shadow: -4px 3px 10px #b5b5b5;
    height: 100%;
    display: flex;
    align-items: center;
