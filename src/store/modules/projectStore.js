...
const actions = {
            ...
            if (project) {
              ...
              if (urlData.page === "map") {
                ...
                if (project.sector === "Construction_Site") {
                  ...
                  console.log(state.datesArray.slice(-1)[0].date)
                  dispatch("switchProjectbyDate", state.datesArray.slice(-1)[0].date);
  ...
  project_type({ commit, state, dispatch },t){
    state.type_pro = t
    console.log(state.type_pro)
